...
apt-get update
apt-get install -y nginx php7.3-fpm php7.3-mysql php7.3-cli php7.3-curl git php7.3-dev php7.3-gd php7.3-mbstring php7.3-zip mysql-server
service nginx stop
